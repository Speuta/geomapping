var geoMapping = /** @class */ (function () {
    ...
    geoMapping.prototype._init = function () {
        ...
        var _initBboxAndPoints = function () {
            _this._bbox = _this._getStaticMapBoundingBoxFromTwoPoints(_this._config.boundingBox[0], _this._config.boundingBox[1], _this._img.width, _this._img.height);
    ...
    ;
    geoMapping.prototype._getStaticMapBoundingBoxFromTwoPoints = function (point1, point2, width, height) {
